                      ...
                      <div><img src="${country.flags.svg}" alt="..."></div>
                        <div class="card-body">
                          ...
                          <p class="card-text">Country code: ${country.cca3}</p>
                           <a class="btn btn-primary" href="https://api.openweathermap.org/data/2.5/weather?q=${country.name.common}&appid=ada45b586f3431fe09de5af36cb3f20a" role="button"style="marigin-bottom:50px">Click for weather</a>
                        </div>
                 </div>`
div.append(div1);                
